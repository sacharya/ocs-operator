...
// GetCRDs returns CustomResourceDefinitions for the OCS meta operator custom resources
func GetCRDs() []*extv1beta1.CustomResourceDefinition {
										...
										Items: &extv1beta1.JSONSchemaPropsOrArray{
											Schema: &extv1beta1.JSONSchemaProps{
												Properties: map[string]extv1beta1.JSONSchemaProps{
													...
													"dataPVCTemplate": extv1beta1.JSONSchemaProps{
														Type: "object",
													},
												},
												Required: []string{"name", "count", "resources", "placement", "dataPVCTemplate"},
												Type:     "object",
											},
										},
									},
					...
					OpenAPIV3Schema: &extv1beta1.JSONSchemaProps{
						Properties: map[string]extv1beta1.JSONSchemaProps{
							...
							"status": extv1beta1.JSONSchemaProps{
								Type: "object",
								Properties: map[string]extv1beta1.JSONSchemaProps{
									"errorMessage": extv1beta1.JSONSchemaProps{
										Type: "string",
									},
									"storageClassesCreated": extv1beta1.JSONSchemaProps{
										Type: "boolean",
									},
								},
							},
...
// GetStorageClusterCR returns an example StorageCluster custom resource
func GetStorageClusterCR() *ocsv1alpha1.StorageCluster {
...
// GetOCSInitializationCR returns an example OCSInitialization custom resource
func GetOCSInitializationCR() *ocsv1alpha1.OCSInitialization {
	return &ocsv1alpha1.OCSInitialization{
		TypeMeta: metav1.TypeMeta{
			APIVersion: "ocs.openshift.io/v1alpha1",
			Kind:       "OCSInitialization",
		},
